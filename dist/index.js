...
async function createSnapshotSwipeAndContinue(lastMsg, lastMsgIndex) {
    ...
    if (!lastMsg.swipes) {
        retry_continue_debug('createSnapshotSwipeAndContinue: initializing swipes array');
    ...
    retry_continue_debug('createSnapshotSwipeAndContinue: created swipe', newSwipeIndex, '| total swipes =', lastMsg.swipes.length);
