...
**Saint's Silly Extensions** is a third-party extension for [SillyTavern](https://github.com/SillyTavern/SillyTavern) that bundles nine roleplay tools into a single extension package:
