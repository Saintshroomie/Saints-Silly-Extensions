...
5. Click **Generate Image** to render it right there on your configured SillyTavern image backend (ComfyUI etc.) — or click **Copy & Close** (or the **Copy** button) and paste the prompt into the image tool of your choice.
